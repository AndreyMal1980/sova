...
?>
<h1> Пользователь <?php echo $model->name.' '.$model->surname; ?></h1>
...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        'date' => array('label' => 'Зарегестрирован', 'value' => date("Y.m.d.  время регистрации  H.i", $model->date))
    ),
));
?>
<hr/>
<table border="1" cellpadding="2" cellspacing="0">
    <tbody>
        <?php foreach ($modelPayToUser as $value) { ?>
        ...
        <?php foreach ($modelPayToUser as $value) { ?>
            ...
            <tr>
                <?php if ($i == $value['programm']['period_of_payment']) { ?>
                    ...
                    <?php
                   if ($i == $value['programm']['period_of_payment']) { ?>
                  <td align='center' style="background-color:yellow;color: black">
                     <?php } else { ?>
                       <td align='center'>  
                 <?php  } ?>
             ...
             <?php } ?>
                ...
                <tr>
                    ...
                    <td align='center'> <?php $datePaymentPay = new DateAndTime($value['pay']['date'], $value['programm']['period_of_payment'], $value['programm']['frequency_of_payments']);
                    echo $datePaymentPay->getDateForPeriodInMonth();?></td>
